...
public class EntrepreneurImplService implements EntrepreneurService{
    ...
    public EntrepreneurImplService(@Qualifier("entrepreneurSQLRepositoryImpl")EntrepreneurRepository entrepreneurRepository ) {
    ...
    public List<Entrepreneur> getAllEN() {
        return entrepreneurRepository.getAllEN();
    }
