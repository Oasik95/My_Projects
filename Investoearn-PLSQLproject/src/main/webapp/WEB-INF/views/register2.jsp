            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form action="submit" modelAttribute="investor" class="users">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-users" id="exampleFirstName"
                                           placeholder="First Name" name="firstname">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-users" id="exampleLastName"
                                           placeholder="Last Name" name="lastname">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-users" id="userName"
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control form-control-users" id="exampleInputEmail"
                                       placeholder="Email Address" name="email">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-users" id="exampleInputphonenumber"
                                       placeholder="PhoneNumber" name="phonenumber">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-users" id="NID"
                                       placeholder="NID" name="nid">
                            </div>
                            <div class="form-group">
                                <input type="date" class="form-control form-control-users" id="dob"
                                       placeholder="DateofBirth" name="dob">
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="password" class="form-control form-control-users"
